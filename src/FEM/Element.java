...
public class Element {
	...
	public Vector computeElementInternalForce(Vector displacement) {
		Vector u = displacement;
		 ...
		 double l = Math.sqrt(Math.pow(a, 2) + Math.pow(b, 2) + Math.pow(c,
		 2));
	...
	public IMatrix computeTangentElementStiffnessMatrix(Vector displacement) {
